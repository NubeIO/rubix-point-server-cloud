...
class AppSetting:
    PORT: int = 2020
    GLOBAL_DIR_ENV = 'RUBIX_POINT_SERVER_MASTER_GLOBAL'
    DATA_DIR_ENV = 'RUBIX_POINT_SERVER_MASTER_DATA'
    CONFIG_DIR_ENV = 'RUBIX_POINT_SERVER_MASTER_CONFIG'
    KEY: str = 'APP_SETTING'
    default_global_dir = 'out'
    default_data_dir: str = 'data'
    default_config_dir: str = 'config'
    default_identifier: str = 'psm'
    ...
    def __init__(self, **kwargs):
        ...
        self.__mqtt_rest_bridge_setting.name = 'psm_mqtt_rest_bridge_listener'
